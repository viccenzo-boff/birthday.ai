...
// 1. Cria a piscina de conexões do Postgres usando a sua URL
...
// 3. Passa o adaptador para o cliente Prisma nascer conectado
const prisma = new PrismaClient({ adapter });

async function main() {
  console.log('🌱 Iniciando o preenchimento do banco de dados...');

  // Lista transcrita das imagens (com o seu nome já removido)
  const contatos = [
    // JANEIRO
  ...
  console.log('✅ Banco de dados populado com sucesso com 103 aniversariantes!');
}
